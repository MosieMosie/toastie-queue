...
const translations = {
  nl: {
    ...
    "people.rowTitle": "Tik om {name} te hernoemen of een kleur te kiezen",
    ...
    "iron.free": "vrij",
    "iron.slotTitle": "{name} — sleep naar het bord of de wachtrij",
    "iron.burnt": "· verbrand! 🔥",
    "iron.ready": "· klaar! 🎉",
    "iron.take": "Pakken ✓",
  ...
  en: {
    ...
    "people.rowTitle": "Tap to rename {name} or pick a color",
    ...
    "iron.free": "free",
    "iron.slotTitle": "{name} — drag to the plate or the queue",
    "iron.burnt": "· burnt! 🔥",
    "iron.ready": "· done! 🎉",
    "iron.take": "Take ✓",
...
const initial = ((): Lang => {
  ...
  return stored && stored in translations ? (stored as Lang) : "en";
})();

const [lang, setLangSignal] = createRoot(() => {
  const [get, set] = createSignal<Lang>(initial);
