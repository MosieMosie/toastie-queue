...
const nl = {
  ...
  "scoreboard.eaten": "gegeten",
  "scoreboard.average": "gemiddeld",
  "scoreboard.noAverage": "nog niet gemeten",
  "scoreboard.samples": "{n} gemeten",
  "scoreboard.fastest": "snelst {time}",
  "scoreboard.slowest": "langzaamst {time}",
  "scoreboard.burnt": "{n} verbrand",
  "scoreboard.decrease": "Haal een tosti af van {name}",
  "scoreboard.increase": "Tel een tosti op bij {name}",
  "scoreboard.trollRookie": "Tosti-stagiair",
  "scoreboard.trollSpeed": "Kaas-sprinter",
  "scoreboard.trollSlow": "Slowcooker",
  "scoreboard.trollBurnt": "Rookmeldertester",
  "scoreboard.trollSteady": "Krokante professional",
  "ad.title": "Een woord van onze sponsor-ish",
  "ad.sponsored": "NEP-ADVERTENTIE - niemand betaalde hiervoor",
  "ad.wait": "Bekijk dit nog {n} sec. voor je tosti wordt vrijgelaten",
  "ad.claim": "Bevrijd {name}'s tosti",
  "ad.unavailable":
    "Die tosti is ondertussen verplaatst - advertentie geannuleerd",
...
const en: Record<TranslationKey, string> = {
  ...
  "scoreboard.eaten": "eaten",
  "scoreboard.average": "average",
  "scoreboard.noAverage": "not measured yet",
  "scoreboard.samples": "{n} measured",
  "scoreboard.fastest": "fastest {time}",
  "scoreboard.slowest": "slowest {time}",
  "scoreboard.burnt": "{n} burnt",
  "scoreboard.decrease": "Remove one toastie from {name}",
  "scoreboard.increase": "Add one toastie to {name}",
  "scoreboard.trollRookie": "Toastie intern",
  "scoreboard.trollSpeed": "Cheese sprinter",
  "scoreboard.trollSlow": "Human slow cooker",
  "scoreboard.trollBurnt": "Smoke alarm tester",
  "scoreboard.trollSteady": "Certified crisp professional",
  "ad.title": "A word from our sponsor-ish",
  "ad.sponsored": "FAKE AD - absolutely nobody paid for this",
  "ad.wait": "Watch for {n}s before your toastie is released",
  "ad.claim": "Liberate {name}'s toastie",
  "ad.unavailable": "That toastie moved in the meantime - ad cancelled",
